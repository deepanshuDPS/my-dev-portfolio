...
const About = () => {
  ...
  return <div className="flex relative w-full overflow-hidden mx-auto">
    <motion.div className="flex flex-col w-full"
      ...
      <div className="flex flex-col md:flex-row bg-[#FBFBFB] justify-center items-center pe-[10%] ">
        ...
        <div className="text-base md:basis-1/2 w-full ps-28 text-gray-500">
          <div className="text-[70px] font-medium my-4 text-black" style={{ lineHeight: "80px" }}>Deepanshu</div>
          <div className="text-lg font-medium my-4 text-[#00998C]">Frontend engineer and App developer</div>
          ...
          <Link to="contact-us" class="flex-row items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-4 text-center inline-flex me-2 mt-28">
            Get in touch
      ...
      <div class="flex flex-col py-28 px-[12%]">
        <div className="text-4xl font-medium">More About Me</div>
        ...
        <Link to="contact-us" class="flex-row items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-4 text-center inline-flex mt-12 w-fit">
          Download my CV
