    ...
    <nav class={`${headerBg} z-10`}>
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="top_logo.png" class="h-8 md:h-16" />
          <span class="self-center text-xl md:text-2xl font-semibold whitespace-nowrap ">Code to Craft</span>
        </a>
        <button
          onClick={toggleMenu}
          type="button"
          class="inline-flex items-center p-2 w-8 h-8 md:w-10 md:h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 "
